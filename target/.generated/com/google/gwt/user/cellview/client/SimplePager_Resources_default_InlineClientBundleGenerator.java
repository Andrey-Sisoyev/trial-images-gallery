...
public class SimplePager_Resources_default_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";}")) : ((".GALD-WOMF{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GALD-WOKF{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GALD-WOLF{cursor:" + ("default")  + ";}"));
    }
